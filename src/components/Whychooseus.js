            ...
            <div className="row justify-content-center justify-content-md-between">
              <div className="col-lg-4 col-md-5 col-sm-10">
                <div className="feature-box">
                  <h4>
                    <i className="fal fa-browser" /> Quality Material
                  </h4>
                  <p>
                ...
                <div className="feature-box">
                  <h4>
                    <i className="fal fa-cog" /> Fully Insured
                  </h4>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                    sed do eiusmod.
                ...
                <div className="feature-box">
                  <h4>
                    <i className="fal fa-headphones-alt" /> Trained Workers
                  </h4>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                    sed do eiusmod.
              ...
              <div className="col-lg-4 col-md-5 col-sm-10">
                <div className="feature-box">
                  <h4>
                    <i className="fal fa-desktop" /> Accredited
                  </h4>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                    sed do eiusmod.
                ...
                <div className="feature-box">
                  <h4>
                    <i className="fal fa-globe" /> Take Guarantee
                  </h4>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                    sed do eiusmod.
                ...
                <div className="feature-box">
                  <h4>
                    <i className="fal fa-lock" /> High quality support
                  </h4>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                    sed do eiusmod.
